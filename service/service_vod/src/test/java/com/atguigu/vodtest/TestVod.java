...
public class TestVod {
    public static void main(String[] args) throws ClientException {
        ...
        // 获取视频凭证
//        getPlayAuth(accessKeyId, accessKeySecret);
        // 获取视频地址
//        getPlayUrl(accessKeyId, accessKeySecret);
    }

    private static void getPlayAuth(String accessKeyId, String accessKeySecret) throws ClientException {
        //1. 创建初始化对象
        ...
        //3. 向request里设置视频id
        request.setVideoId("771aa416448048c392df51a83c76ae94");
    ...
    private static void getPlayUrl(String accessKeyId, String accessKeySecret) throws ClientException {
        // 根据视频id获得视频的播放地址
        //1. 创建初始化对象
        DefaultAcsClient client = InitObject.initVodClient(accessKeyId, accessKeySecret);
        //2. 创建获取视频地址 request 和 response
